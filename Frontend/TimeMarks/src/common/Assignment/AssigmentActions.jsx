...
export const AssigmentActions = ({setShowCreationPanel}) => {
  
  return (
    <div className='w-full justify-end flex mr-10 mb-2 text-md'>
        <div className='w-1/3'>
        <button className='flex flex-row m-auto bg-slate-300 border-2 border-gray-400 p-1 rounded-md hover:bg-slate-400' onClick={setShowCreationPanel}>
        <img src={add}/>
