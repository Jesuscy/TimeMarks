...
export const UserCard = () => {
  return (
    <div className='w-full flex flex-row items-center justify-center bg-gray-300  p-3 pt-1 pb-1 border-gray-400 cursor-pointer'>
    <div className='w-1/4'><img className='ml-2 h-10 w-12 rounded-full bg-customBlue'/></div>
    <div className='w-3/4 flex flex-col justify-center'>
        <div className='w-full text-start font-rubik font-medium mt-5 text-medium'>Jesus Carrasco</div>
